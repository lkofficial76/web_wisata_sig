    ...
    <div class="row">
        <div class="col-4">
            <div class="mb-3">
                ...
                // Check if $query is not null before accessing its properties
                $id_kabupaten = $query ? $query->id_kabupaten : '';
                echo form_dropdown('id_kabupaten', $kabupatenOptions, $id_kabupaten, 'class="form-control"'); 
                ?>
            </div>
            <div class="mb-3">
                ...
                $kode_kecamatan = [
                    ...
                    'required' => 'required',
                    'value' => $query ? $query->kode_kecamatan : '$kode_kecamatan'
                ];
            ...
            <div class="mb-3">
                ...
                $nama_kecamatan = [
                    ...
                    'required' => 'required',
                    'value' => $query ? $query->nama_kecamatan : ''
                ];
            ...
            <div class="mb-3">
                ...
                $jumlah_penduduk = [
                    ...
                    'required' => 'required',
                    'value' => $query ? $query->jumlah_penduduk : ''
                ];
            ...
            <div class="mb-3">
                ...
                $luas_wilayah = [
                    ...
                    'required' => 'required',
                    'value' => $query ? $query->luas_wilayah : ''
                ];
